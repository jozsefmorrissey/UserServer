...
public class ClientTest
{
	...
	long originalId;
	UUser user = buildValidUser();

	private UUser buildValidUser() {
		UUser u = new UUser(0, nameOriginal, emailValid, passwordValid);
    ...
    public void login() {
    	try {
			UUser tokenCarrier = userSrvcExt.loginUser(user);
