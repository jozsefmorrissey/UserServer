...
public class URI extends ToJson {
	...
	public static final String EMAIL_OR_ID = "/{emailORid}";
	
	public static final String USER = "/user";
	public static final String USER_ADD = USER + "/add";
	public static final String USER_LOGIN = USER + "/login";
	public static final String USER_EMAIL_OR_ID = USER + EMAIL_OR_ID;
	public static final String USER_ALL = USER + ALL;
	public static final String USER_UPDATE = USER + UPDATE;
	public static final String USER_AUTHINTICATE = USER + "/authinticate";
